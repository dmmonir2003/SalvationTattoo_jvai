      ...
      <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-2xl bg-[#0D0D0D] border border-[#968B79]/60 rounded-[32px] overflow-hidden shadow-2xl">
          ...
          <div className="p-8 space-y-8">
              ...
              <div className="bg-[#141414] border border-[#968B79]/60 rounded-2xl p-6 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <div className="bg-blue-500/10 text-blue-400 text-[10px] font-bold px-3 py-1.5 rounded-lg w-fit flex items-center gap-1.5 border border-blue-500/20 uppercase tracking-wider">
                      <CheckCircle2 size={12} /> {data.status}
                    </div>
                  </div>
                </div>
            ...
            {/* Action Buttons */}
            <div className="flex gap-4 pt-2">
              <button className="flex-1 bg-emerald-500/5 border border-emerald-500/20 text-emerald-500 py-4 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-emerald-500/10 transition-all active:scale-95">
                <Check size={18} /> Approve Task
              </button>
              <button
