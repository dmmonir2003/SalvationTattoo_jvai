  ...
  return (
    <div className="space-y-8 p-4 bg-black min-h-screen text-white">
      ...
      <div className="space-y-4">
        {/* DESKTOP TABLE */}
        <div className="hidden md:block bg-[#0A0A0A] border border-[#262626] rounded-[32px] overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="text-gray-600 text-[10px] uppercase font-bold tracking-widest border-b border-[#1A1A1A]">
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex gap-3">
                  <div
                    className={cn(
                      "w-10 h-10 rounded-xl flex items-center justify-center border border-[#262626] shrink-0",
                      task.status === "Overdue"
                        ? "bg-red-500/10"
                        : "bg-[#141414]",
                    )}
              ...
              <div className="flex gap-2 pt-1">
                {task.status === "Awaiting Review" && (
                  <>
                    <button className="flex-1 flex items-center justify-center gap-2 py-3 bg-emerald-500/10 text-emerald-500 rounded-xl text-xs font-bold">
