...
export const InstructionCategory = ({
  ...
  <div className="bg-[#0A0A0A] border border-[#262626] rounded-[2rem] p-5 md:p-8 space-y-6">
    {/* Category Header */}
    <div className="flex items-center gap-4">
      <div
        className={cn(
    ...
    <div className="space-y-4">
      {instructions.map((item) => (
        <div
          key={item.id}
          className="bg-[#111] border border-[#262626] rounded-2xl p-5 md:p-6 group hover:border-[#404040] transition-all"
        >
