            ...
            {users.map((user) => (
              ...
              >
                ...
                <td className="px-4 py-5 text-right space-x-2">
                  {/* Removed group-hover:opacity-100 to keep them visible always */}
                  <button
                    onClick={() => onEdit(user)}
        ...
        {users.map((user) => (
          ...
          >
            ...
            <div className="flex items-center justify-end gap-3 pt-1">
              <button
                onClick={() => onEdit(user)}
                className="flex items-center gap-2 px-4 py-2 bg-[#1A1A1A] text-gray-300 rounded-lg text-sm font-medium hover:bg-[#262626]"
              >
                <Edit2 size={14} /> Edit
              </button>
              <button
                onClick={() => onDelete?.(user)}
                className="flex items-center gap-2 px-4 py-2 bg-red-500/10 text-red-500 rounded-lg text-sm font-medium hover:bg-red-500/20"
              >
